  ...
  const response = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: "user",
          content: `استخرج من هذا النص: اسم المتجر، المبلغ، التاريخ، والتصنيف (مطاعم/قهوة/بنزين/سوبرماركت/تسوق/أخرى). أرجع JSON فقط بهذا الشكل: {"store":"","amount":"","date":"","category":""}. النص: ${smsText}`,
        },
      ],
    }),
  });
